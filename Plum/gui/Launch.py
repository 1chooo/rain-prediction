...
import textwrap
from Plum.gui.Dashboard import generate_playground
from Plum.gui.Dashboard import generate_data_process
from Plum.gui.Dashboard import generate_motivation
from Plum.gui.Dashboard import generate_trained_process
from Plum.gui.Dashboard import generate_trained_results

def build_ui(confusion, accuracy, recall, precision, proba):
    demo = gr.Blocks(
        title='梅雨還是沒雨？',
    )
